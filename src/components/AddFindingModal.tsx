...
const AddFindingModal: React.FC<AddFindingModalProps> = ({ isOpen, onClose, onSave, findingToEdit }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      {/* Modal Card */}
      <div className="relative bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200" aria-describedby="modal-description">
